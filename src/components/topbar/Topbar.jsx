            ...
            <div className="wrapper">
                <div className="left">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.05 59.23">
                        <defs>
                            <style>{'.cls-1,.cls-3,.cls-4{fill:none;stroke:#1A1A1A;stroke-miterlimit:10;}.cls-1,.cls-4{stroke-width:6px;}.cls-2{fill:#B39374;}.cls-3,.cls-4{stroke-linecap:round;}.cls-3{stroke-width:2px;}'}</style>
                            </defs>
